<!--  Header Start -->
<header class="app-header bg-light-gray" id="navbarScroll" style="transition: top 0.3s; z-index: 999;">
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="navbar-collapse justify-content-between px-0" id="navbarNav">
            <h4 class="d-none d-lg-block mb-0">Sistem Manajemen Keuangan</h4>
            <ul class="navbar-nav align-items-center justify-content-between">
                <li class="nav-item d-block d-lg-none">
                    <h4 class="mb-0">Sistem Manajemen Keuangan</h4>
                </li>
                <li class="nav-item dropdown">
                    <a onclick="openFullscreen()" class="nav-link nav-icon-hover" href="javascript:void(0)" id="full-screen-button">
